...
const Sidebar = () => {
    return (
        <aside className={'bg-[#2E3785] h-full flex flex-col shadow-base min-w-[230px]'}>
            <Link href={'/administrator'} className={'inline-block py-3.5 pl-6 bg-[#0D0752] shadow-base min-h-16'}>
