...
export const fetchAnketaOborotFromDate = async ({startDate, endDate} : {startDate:Date | undefined, endDate:Date | undefined}) => {
...
export const fetchAnketaOborotPurchaseStoMoney = async ({startDate, endDate} : {startDate:Date | undefined, endDate:Date | undefined}) => {
...
export const fetchAnketaOborotPurchaseStoCount = async ({startDate, endDate} : {startDate:Date | undefined, endDate:Date | undefined}) => {
    // Проверяем, что startDate и endDate определены
    if (startDate && endDate) {
        // Форматируем и кодируем параметры
        const formattedStartDate = encodeURIComponent(startDate.toISOString());
...
export const fetchAnketaOborotRemzonaQty = async ({startDate, endDate} : {startDate:Date | undefined, endDate:Date | undefined}) => {
    // Проверяем, что startDate и endDate определены
    if (startDate && endDate) {
        // Форматируем и кодируем параметры
        const formattedStartDate = encodeURIComponent(startDate.toISOString());
...
export const fetchAnketaOborotNotByDistributor = async ({startDate, endDate} :{startDate:Date | undefined, endDate:Date | undefined}) => {
    if (startDate && endDate) {
        // Форматируем и кодируем параметры
        const formattedStartDate = encodeURIComponent(startDate.toISOString());
        const formattedEndDate = encodeURIComponent(endDate.toISOString());
