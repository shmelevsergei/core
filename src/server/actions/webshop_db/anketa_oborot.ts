...
class AnketaOborot {
    getAnketaOborot = cache(
        async ({
            ...
            const result = await prismaWebShop.$queryRaw<
                Array<AnketaOborotResult>
            >`
    ...
    getAnketaOborotPurchaseSto = cache(
        async ({
            startDate,
            endDate,
        }: {
    ...
    getAnketaOborotPurchaseStoCount = cache(
        async ({
            startDate,
            endDate,
        }: {
    ...
    getAnketaOborotRemsonaQty = cache(
        async ({
            startDate,
            endDate,
        }: {
    ...
    getAnketaOborotNotByDistributor = cache(
        async ({
            startDate,
            endDate,
        }: {
