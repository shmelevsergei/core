...
const InputCitySto = () => {
    ...
    return (
        ...
        <div className={`grid w-full max-w-sm items-center gap-1.5`}>
            ...
            <AddressSuggestions token={apiKey} value={value} onChange={setValue} uid={id} minChars={3} ref={cityRef} inputProps={{name: 'city', id:id, placeholder: 'Город'}} containerClassName={'input'} highlightClassName={'item'} />
        </div>
