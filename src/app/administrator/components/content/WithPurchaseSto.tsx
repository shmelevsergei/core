...
const WithPurchaseSto = () => {
    ...
    const [prevPurchaseSto, setPrevPurchaseSto] = useState<IAnketaBaseRepository[]>([])
    ...
    useEffect(() => {
        if (prevPurchaseSto && purchaseSto) {
            setPercent((purchaseSto.length - prevPurchaseSto.length) / prevPurchaseSto.length * 100)
        }
