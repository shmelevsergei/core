...
export namespace Prisma {
  ...
  */
            ...
            Anketa: {
                ...
                operations: {
                    ...
                    count: {
                        ...
                        result:
                            | $Utils.Optional<AnketaCountAggregateOutputType>
                            | number
                    }
                }
            }
    ...
    > = {
         ...
         */
        orderBy?:
            | AnketaOrderByWithRelationInput
            | AnketaOrderByWithRelationInput[]
        /**
    ...
    > = {
        where?: AnketaWhereInput
        orderBy?:
            | AnketaOrderByWithAggregationInput
            | AnketaOrderByWithAggregationInput[]
    ...
    type GetAnketaGroupByPayload<T extends AnketaGroupByArgs> =
        Prisma.PrismaPromise<
            Array<
                PickEnumerable<AnketaGroupByOutputType, T['by']> & {
                    [P in keyof T &
                        keyof AnketaGroupByOutputType]: P extends '_count'
                        ? T[P] extends boolean
                            ? number
    ...
    type AnketaGetPayload<
        S extends boolean | null | undefined | AnketaDefaultArgs,
    > = $Result.GetResult<Prisma.$AnketaPayload, S>

    type AnketaCountArgs<
        ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
    > = Omit<AnketaFindManyArgs, 'select' | 'include' | 'distinct'> & {
        select?: AnketaCountAggregateInputType | true
    }

    export interface AnketaDelegate<
        ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
    > {
        [K: symbol]: {
            types: Prisma.TypeMap<ExtArgs>['model']['Anketa']
            meta: { name: 'Anketa' }
        }
        /**
        ...
        ): Prisma__AnketaClient<
            $Result.GetResult<
                Prisma.$AnketaPayload<ExtArgs>,
                T,
                'findUnique'
            > | null,
            null,
        ...
        findMany<T extends AnketaFindManyArgs<ExtArgs>>(
            ...
            $Result.GetResult<Prisma.$AnketaPayload<ExtArgs>, T, 'findMany'>
        >
        ...
        create<T extends AnketaCreateArgs<ExtArgs>>(
            ...
            $Result.GetResult<Prisma.$AnketaPayload<ExtArgs>, T, 'create'>,
            never,
            ExtArgs
        >
        ...
        delete<T extends AnketaDeleteArgs<ExtArgs>>(
            ...
            $Result.GetResult<Prisma.$AnketaPayload<ExtArgs>, T, 'delete'>,
            never,
            ExtArgs
        >
        ...
        update<T extends AnketaUpdateArgs<ExtArgs>>(
            ...
            $Result.GetResult<Prisma.$AnketaPayload<ExtArgs>, T, 'update'>,
            never,
            ExtArgs
        >
        ...
        upsert<T extends AnketaUpsertArgs<ExtArgs>>(
            ...
            $Result.GetResult<Prisma.$AnketaPayload<ExtArgs>, T, 'upsert'>,
            never,
            ExtArgs
        >
         ...
         * })
         **/
        aggregate<T extends AnketaAggregateArgs>(
            args: Subset<T, AnketaAggregateArgs>
        ): Prisma.PrismaPromise<GetAnketaAggregateType<T>>
        ...
        >(
            args: SubsetIntersection<T, AnketaGroupByArgs, OrderByArg> &
                InputErrors
        ): {} extends InputErrors
            ? GetAnketaGroupByPayload<T>
     ...
     */
    export interface Prisma__AnketaClient<
        T,
        Null = never,
        ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
     ...
     * Anketa findUnique
     */
    export type AnketaFindUniqueArgs<
        ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
    > = {
        /**
     ...
     */
    export type AnketaFindUniqueOrThrowArgs<
        ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
    > = {
        /**
         * Select specific fields to fetch from the Anketa
     ...
     * Anketa findFirst
     */
    export type AnketaFindFirstArgs<
        ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
    > = {
        /**
         * Select specific fields to fetch from the Anketa
     ...
     */
    export type AnketaFindFirstOrThrowArgs<
        ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
    > = {
        /**
         * Select specific fields to fetch from the Anketa
    ...
    export type AnketaScalarFieldEnum =
        (typeof AnketaScalarFieldEnum)[keyof typeof AnketaScalarFieldEnum]
    ...
    export type AnketaScalarWhereWithAggregatesInput = {
        AND?:
            | AnketaScalarWhereWithAggregatesInput
            | AnketaScalarWhereWithAggregatesInput[]
